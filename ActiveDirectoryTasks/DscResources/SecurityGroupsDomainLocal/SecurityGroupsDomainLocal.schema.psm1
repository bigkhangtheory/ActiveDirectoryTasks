<#
    .DESCRIPTION
        This DSC configuration manages groups and group memberships for Default Builtin Groups within Active Directory
    .PARAMETER DomainDN
...
configuration SecurityGroupsDomainLocal
{
    param
    (
        [Parameter(Mandatory)]
...
'@
        ...
        $executionName = "$($g.GroupScope)_$($g.GroupName -replace '[-().:\s]', '_')"
