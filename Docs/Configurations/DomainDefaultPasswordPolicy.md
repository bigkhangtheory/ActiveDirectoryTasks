...
|                  |                                                                                                                                  |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **Source**       | https://github.com/bigkhangtheory/ActiveDirectoryTasks/tree/master/ActiveDirectoryTasks/DscResources/DomainDefaultPasswordPolicy |
| **Dependencies** | [ActiveDirectoryDsc][ActiveDirectoryDsc], [xPSDesiredStateConfiguration][xPSDesiredStateConfiguration]                           |
| **Resources**    | [ADDomainDefaultPasswordPolicy][ADDomainDefaultPasswordPolicy], [xWindowsFeature][xWindowsFeature]                               |
...
### Table. Attributes of `DomainDefaultPasswordPolicy`
...
## Example `DomainDefaultPasswordPolicy`
