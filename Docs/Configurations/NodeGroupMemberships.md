...
The **NodeGroupMemberships** is used to enroll a Node into a Security Group within Active Directory.

This configuration assumes the current target Node that is receiving this configuration.
...
|                  |                                                                                                                           |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **Source**       | https://github.com/bigkhangtheory/ActiveDirectoryTasks/tree/master/ActiveDirectoryTasks/DscResources/NodeGroupMemberships |
...
### Table. Attributes of `NodeGroupMemberships`

| Parameter            | Attribute  | DataType         | Description                                                            | Allowed Values |
| :------------------- | :--------- | :--------------- | :--------------------------------------------------------------------- | :------------- |
| **DomainDn**         | *Required* | `[String]`       | Distinguished Name (DN) of the domain.                                 |                |
| **DomainController** | *Required* | `[String]`       | Active Directory domain controller to enact the change upon.           |                |
| **Credential**       | *Required* | `[PSCredential]` | Credentials used to enact the change upon.                             |                |
| **Groups**           | *Required* | `[String]`       | Specify a list of Active Directory security groups to enroll the Node. |                |

---

<br />

## Example `NodeGroupMemberships`
