...
|                  |                                                                                                                                  |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **Source**       | https://github.com/bigkhangtheory/ActiveDirectoryTasks/tree/master/ActiveDirectoryTasks/DscResources/ForestServicePrincipalNames |
...
### Table. Attributes of `ForestServicePrincipalNames`
...
## Example `ForestServicePrincipalNames`
